...
export default function Footer() {
  return (
    <footer className="relative w-full">
      {/* Image */}
      <div
        className="absolute inset-0 min-h-[400px] -z-10"
        style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-24 lg:gap-8 w-full">
          ...
          <div className="lg:col-span-2 -mr-4">
            <div className="flex items-start gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold text-black">Air Berotot</h3>
            </div>
            
            <p className="text-sm font-semibold text-gray-700 mb-6 max-w-xs leading-relaxed">

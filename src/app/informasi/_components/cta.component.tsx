  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <div className="bg-[#6BA5D6] rounded-[30px] border-8 border-white/48 p-12 text-center">
          <h2 className="text-white text-3xl md:text-4xl font-black mb-4">
            Bagikan Kisah Anda
          </h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Cerita Anda bisa menjadi cahaya harapan bagi mereka yang sedang
            berjuang. Mari berbagi kekuatan.
          </p>
